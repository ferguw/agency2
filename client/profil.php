                                ...
                                <div class="card-body">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between flex-wrap mt-1">
                                                <div class="d-flex mr-3">
                                                    <a href="#"
                                                        ...
                                                        Muller</a>
                                                    <a href="#"><i
                                                            class="flaticon2-correct text-success font-size-h5"></i></a>
                                                </div>
                                            ...
                                            <div class="d-flex flex-wrap justify-content-between mt-1">
                                                <div class="d-flex flex-column flex-grow-1 pr-8">
                                                    ...
                                                    <span class="font-weight-bold text-dark-50">I distinguish three main
                                                        text objectives could be merely to inform people.</span>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap mt-8">
                                        ...
                                        <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                                            <span class="mr-4">
                                                <i
                                                    class="flaticon-piggy-bank display-4 text-muted font-weight-bold"></i>
                                            </span>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <img src="assets/media/portofolio/1.png" width="100%"
                                                        alt="portofolio">
                                                </div>
                                                <div class="col-lg-3">
                                                    <img src="assets/media/portofolio/2.png" width="100%"
                                                        alt="portofolio">
                                                </div>
                                                <div class="col-lg-3">
                                                    <img src="assets/media/portofolio/3.png" width="100%"
                                                        alt="portofolio">
                                                </div>
                                                <div class="col-lg-3">
                                                    <img src="assets/media/portofolio/1.png" width="100%"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <img src="assets/media/books/1.png" width="100%" alt="Edication">
                                                </div>
                                                <div class="col-lg-2">
                                                    <img src="assets/media/books/2.png" width="100%" alt="Edication">
                                                </div>
                                                <div class="col-lg-2">
                                                    <img src="assets/media/books/3.png" width="100%" alt="Edication">
                                                </div>
                                                <div class="col-lg-2">
                                                    <img src="assets/media/books/4.png" width="100%" alt="Edication">
                                                </div>
                                                <div class="col-lg-2">
                                                    <img src="assets/media/books/5.png" width="100%" alt="Edication">
                                                </div>
                                                <div class="col-lg-2">
                                                    <img src="assets/media/books/6.png" width="100%" alt="Edication">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                            ...
                            <div class="row justify-content-between" style="width: 100%;">
                                <div class="col-6">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label font-weight-bolder text-dark">TOP SKILL</span>
                                    </h3>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="client/profil"
                        ...
                        <div class="card-body pt-8">
                            ...
                            <div class="d-flex align-items-center mb-1">
                                ...
                                <div class="d-flex flex-column font-weight-bold">
                                    <span class="text-dark text-hover-primary mb-1 font-size-lg">Kepemimpinan</span>
                                    <span class="text-dark text-hover-primary mb-1 font-size-lg">Komunikasi</span>
                                    <span class="text-dark text-hover-primary mb-1 font-size-lg">Kreatif</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                    ...
                    <div class="card card-custom card-shadowless bg-white gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <div class="row justify-content-between" style="width: 100%;">
                                <div class="col-12">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label font-weight-bolder text-dark">Certifications</span>
                                    </h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center mb-1">
                                ...
                                <div class="d-flex flex-column font-weight-bold">
                                    <div class="row justify-content-center style=" width: 100%;">
                                        <div class="col-8">
                                            <!-- <img src="assets/media/sertifikat/doc.svg" width="100%" alt="Edication"> -->
