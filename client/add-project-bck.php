...
<body id="kt_body" class="header-fixed header-mobile-fixed sidebar-enabled page-loading">
                                ...
                                <div id="kt_header_menu"
                                    ...
                                    <ul class="menu-nav ">
                                        ...
                                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                            aria-haspopup="true">
                                            <a href="client/report-job" class="menu-link"><span
                                                    class="menu-text">Report</span><span class="menu-desc"></span><i
                                                    class="menu-arrow"></i></a>
                                        </li>
                                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                            aria-haspopup="true">
                                            <a href="client/history" class="menu-link"><span
                                                    ...
                                                    <div class="pb-5" data-wizard-type="step-content"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Customer
                                                                        Name</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            ...
                                                                            value="Loop Inc." />
                                                                        <span class="form-text text-muted">If
                                                                            you
                                                                            want
                                                                            your
                                                                            invoices
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="form-group row">
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <h3
                                                                            class="kt-section__title kt-section__title-md">
                                                                            Project
                                                                            Settings
                                                                        </h3>
                                                                    </div>
                    ...
                    <div class="card card-custom card-shadowless bg-white gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">Pengajuan
                                    Gabung Project</span>
                                <span class="text-muted mt-3 font-weight-bold font-size-sm">5
                                    Pengajuan Menunggu</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
    ...
    <div id="kt_quick_notifications" class="offcanvas offcanvas-left p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between mb-10">
            <h3 class="font-weight-bold m-0">
                Notifications
                <small class="text-muted font-size-sm ml-2">24
                    New</small>
            </h3>
    ...
    <div id="kt_quick_actions" class="offcanvas offcanvas-left p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-10">
            <h3 class="font-weight-bold m-0">
                Quick Actions
                <small class="text-muted font-size-sm ml-2">finance
                    & reports</small>
            </h3>
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            <h3 class="font-weight-bold m-0">
                User Profile
                <small class="text-muted font-size-sm ml-2">12
                    messages</small>
            </h3>
        ...
        <div class="offcanvas-content px-10">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                    <!--begin::Section-->
                    <div class="mb-15">
                        <h5 class="font-weight-bold mb-5">System
                            Messages</h5>
                        <!--begin: Item-->
                ...
                <div class="tab-pane fade pt-3 pr-5 mr-n5" id="kt_quick_panel_settings" role="tabpanel">
                    <form class="form">
                        ...
                        <div>
                            ...
                            <div class="form-group mb-0 row align-items-center">
                                <label class="col-8 col-form-label">Support
                                    Portal:</label>
                                <div class="col-4 d-flex justify-content-end">
                                    <span class="switch switch-success switch-sm">
                                        <label>
                        ...
                        <div class="pt-2">
                            <h5 class="font-weight-bold mb-3">
                                Reports</h5>
                            <div class="form-group mb-0 row align-items-center">
                                <label class="col-8 col-form-label">Generate
                                    Reports:</label>
                                <div class="col-4 d-flex justify-content-end">
                            ...
                            <div class="form-group mb-0 row align-items-center">
                                <label class="col-8 col-form-label">Allow
                        ...
                        <div class="scroll scroll-pull" data-height="375" data-mobile-height="300">
                            ...
                            <div class="messages">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                                ...
                                                Pears</a>
                                            <span class="text-muted font-size-sm">2
                                                Hours</span>
                                        </div>
                                    </div>
                                    <div
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <span class="text-muted font-size-sm">3
                                                minutes</span>
                                            <a href="#"
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <span class="text-muted font-size-sm">Just
                                                now</span>
                                            <a href="#"
                                                class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">You</a>
                                        </div>
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    ...
                                    <div
                                        ...
                                        by clicking here: <a href="#">https://github.com</a>
                                    </div>
                                </div>
                                <!--end::Message In-->
                                <!--begin::Message Out-->
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    ...
                                    <div
                                        ...
                                        who viewed Learn Figma -
                                        UI/UX Design. Essential
                                        Training
                                        also viewed
                                    </div>
                                </div>
        ...
        <div class="offcanvas-content">
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming
                            soon</a>
                    </div>
                </div>
                <h5 class="font-weight-bold mb-4 text-center">
    ...
    <script src="assets/js/pages/custom/projects/add-project.js?v=7.0.6">
    </script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
