                                            ...
                                            <div class="col-xl-12 col-xxl-7">
                                                ...
                                                <form class="form" id="kt_projects_add_form" method="post">
                                                    ...
                                                    <div class="pb-5" data-wizard-type="step-content"
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            ...
                                                                            value="<?php echo $_GET['projectname']; ?>"
                                                                            type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            ...
                                                                            value="<?php echo $_GET['compname']; ?>"
                                                                            type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Periode</label>
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            <Label>Date & Time Start</Label>
                                                                            <input
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                readonly name="dtstart"
                                                                                value="<?php echo $_GET['dtstart']; ?>"
                                                                                type="datetime-local">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            readonly name="numday" placeholder="10"
                                                                            value="<?php echo $_GET['numday']; ?>"
                                                                            type="number" min="0">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                for ($i = 0; $i < $jumlah; $i++) {
                                                                    ...
                                                                    if (isset($_POST['sendproject'])) {
                                                                        $query_idj_search = mysqli_query($conn, "SELECT * FROM job WHERE idc = '$idc' AND judul = '$projectname' ");
                                                                        $data_idj_search = mysqli_fetch_assoc($query_idj_search);
                                                                        $idj = $data_idj_search['idj'];
                                                                        mysqli_query($conn, "INSERT INTO job_req (`idjr`, `idj`, `numtalent`, `salary`, `type`) VALUES (NULL, '$idj', '$talentamout[$i]', '$salary[$i]', '$talenttype[$i]')");
                                                                    }
                                                                    echo "
                                                                            <div class='form-group row'>
                                                                ...
                                                                <div class='form-group row'>
                                                                    <label
                                                                        class='col-xl-3 col-lg-3 col-form-label'>Total
                                                                        Salary</label>
                                                                    <div class='col-lg-9 col-xl-9'>
                                                                        <div
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="<?php echo $totalsalary; ?>"
                                                                                type='number'>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class='form-group row'>
                                                                    <label class='col-xl-3 col-lg-3 col-form-label'>Fee
                                                                        Gawiae</label>
                                                                    <div class='col-lg-9 col-xl-9'>
                                                                        <div
                                                                            class='input-group input-group-lg input-group-solid'>
                                                                            <div class='input-group-prepend'><span
                                                                                    class='input-group-text'><i
                                                                                        class='la'>10% Rp</i></span>
                                                                            </div>
                                                                            <input
                                                                                class='form-control form-control-lg form-control-solid'
                                                                                readonly name='fee_gawiae'
                                                                                value='<?php echo $feegawiae; ?>'
                                                                                type='number'>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class='form-group row'>
                                                                    <label
                                                                        class='col-xl-3 col-lg-3 col-form-label'>Grand
                                                                        Total</label>
                                                                    <div class='col-lg-9 col-xl-9'>
                                                                        <div
                                                                            class='input-group input-group-lg input-group-solid'>
                                                        ...
                                                        <input type="text" hidden name="projectdescription"
                                                            value="<?php echo $_GET['projectdescription']; ?>">
                                                        <input type="text" hidden name="companywebsite"
                                                            value="<?php echo $_GET['companywebsite']; ?>">
                                                        <input type="text" hidden name="city"
                                                            value="<?php echo $_GET['city']; ?>">
                                                        <input type="text" hidden name="location"
                                                            value="<?php echo $_GET['location']; ?>">
                                                        <input type="text" hidden name="workday"
                                                            value="<?php echo $_GET['workday']; ?>">
