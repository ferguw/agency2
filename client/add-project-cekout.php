                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            ...
                                                                            placeholder="Project Name" name="projectname" readonly value="<?php echo $_GET['projectname']; ?>" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <div
                                                                            ...
                                                                            <input type="tel"
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                placeholder="081234567890" name="phone" readonly value="<?php echo $_GET['phone']; ?>"
                                                                                pattern="[0-9]{11-12}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <div
                                                                            ...
                                                                            <input type="email"
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                readonly name="email" value="<?php echo $_GET['email']; ?>"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            readonly name="address" value="<?php echo $_GET['address']; ?>"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                readonly name="dtstart" value="<?php echo $_GET['dtstart']; ?>"
                                                                                type="datetime-local">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                readonly name="dtend" value="<?php echo $_GET['dtend']; ?>"
                                                                                type="datetime-local">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            readonly name="numday" placeholder="10"  value="<?php echo $_GET['numday']; ?>"
                                                                            type="number" min="0">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <div
                                                                            ...
                                                                            <input type="text"
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                readonly name="salary" value="<?php echo $_GET['salary']; ?>"
                                                                                placeholder="1000000" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            readonly name="amounttalent" placeholder="10" value="<?php echo $_GET['amounttalent']; ?>"
                                                                             type="number" min="0">
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Grad Total</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <div
                                                                            class="input-group input-group-lg input-group-solid">
                                                                            <div class="input-group-prepend"><span
                                                                            ...
                                                                            <?php $numday = $_GET['numday']; $salary = $_GET['salary']; $amounttalent = $_GET['amounttalent'];
                                                                            $grandtotal = $numday * $salary * $amounttalent; ?>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg form-control-solid"
                                                                                readonly value="<?php echo $grandtotal;?>"
                                                                                placeholder="1000000" />
                                                                        </div>
                                                                    </div>
                                                                </div>
