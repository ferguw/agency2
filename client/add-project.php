...
<body id="kt_body" class="header-fixed header-mobile-fixed sidebar-enabled page-loading">
                                ...
                                <div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
                                    ...
                                    <ul class="menu-nav ">
                                        <li class="menu-item menu-item-submenu menu-item-rel">
                                            <a href="client" class="menu-link "><span class="menu-text">Dashboard</span></a>
                                        </li>
                                        <li class="menu-item menu-item-submenu menu-item-rel menu-item-open menu-item-here">
                                            <a href="client/list-project" class="menu-link "><span class="menu-text">Project</span></a>
                                        </li>

                                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="client/report-job" class="menu-link"><span class="menu-text">Report</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                        </li>
                                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="client/history" class="menu-link"><span class="menu-text">History</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                        </li>
                                    </ul>
                                    <!--end::Nav-->
                                </div>
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="projectname" required placeholder="Project Name" autocomplete="off" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Project
                                                                        Description</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <textarea name="projectdescription" required placeholder="Description" class="form-control form-control-lg form-control-solid" rows="8" cols="80"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <div class="input-group input-group-lg input-group-solid">
                                                                            ...
                                                                            <input type="tel" class="form-control form-control-lg form-control-solid" name="phone" required placeholder="081234567890" title="Input 12 Digit Phone Number" pattern="[0-9]{12}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <div class="input-group input-group-lg input-group-solid">
                                                                            ...
                                                                            <input type="email" class="form-control form-control-lg form-control-solid" name="email" required autocomplete="off" placeholder="example@mail.com" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="address" required placeholder="Jl. Utara" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">City</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <select name="city" required class="form-control form-control-lg form-control-solid">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Maps
                                                                        Coordinates</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="location" required type="text" autocomplete="off" placeholder="-3.3187897349614994, 114.59119085304802">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control form-control-lg form-control-solid" name="dtstart" required autocomplete="off" type="datetime-local">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            <Label>Date & Time End</Label>
                                                                            <input class="form-control form-control-lg form-control-solid" name="dtend" required autocomplete="off" type="datetime-local">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Work
                                                                        Day</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="workday" placeholder="Senin - Jumat" autocomplete="off" required type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Number
                                                                        of Days</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="numday" placeholder="10" required autocomplete="off" type="number" min="0">
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                ...
                                                                <div class="form-group row" id="need">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Number
                                                                        of Talent</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="talentamout[]" placeholder="10" required autocomplete="off" type="number" min="0">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row" id="need">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Salary Per Day</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control form-control-lg form-control-solid" name="salary[]" placeholder="100000" required autocomplete="off" type="number" min="0">
                                                                    </div>
                                                                </div>
                                                                <div id="tambah-data-type"></div>
    ...
    <script type="text/javascript">
        $("#tambah-type").click(function() {
            ...
            html += '</div>';
            html += '<div class="form-group row" id="need">';
            html += '<label class="col-xl-3 col-lg-3 col-form-label">Number of Talent </label>';
            html += '<div class="col-lg-9 col-xl-9">';
            html += '<input class="form-control form-control-lg form-control-solid" name="talentamout[]" placeholder="10" required autocomplete="off" type="number" min="0">';
            html += '</div>';
            html += '</div>';
            html += '<div class="form-group row" id="need">';
            html += '<label class="col-xl-3 col-lg-3 col-form-label">Salary Per Day</label>';
            html += '<div class="col-lg-9 col-xl-9">';
            html += '<input class="form-control form-control-lg form-control-solid" name="salary[]" placeholder="100000" required autocomplete="off" type="number" min="0">';
            html += '</div>';
            html += '</div>';

            $('#tambah-data-type').append(html);
        });
    </script>
