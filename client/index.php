                ...
                <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class=" container-fluid ">
                            ...
                            <!--begin::Row-->
                            <div class="row">
<?php while($data_client_list_project = mysqli_fetch_assoc($query_client_list_project)) { ?>
                                <div class="col-xl-6">
                                    <!--begin::Card-->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column mr-auto">
                                                    ...
                                                    <a href="client"
                                                        ...
                                                        <?php echo $data_client_list_project['judul']; ?>
                                                    </a>
                                            ...
                                            <div class="d-flex flex-wrap mt-14">
                                                <div class="mr-12 d-flex flex-column mb-7">
                                                    ...
                                                    <span
                                                        class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_client_list_project['start']; ?></span>
                                                </div>
                                                <div class="mr-12 d-flex flex-column mb-7">
                                                    <span class="d-block font-weight-bold mb-4">
                                                        Due Date
                                                    ...
                                                    <span
                                                        class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_client_list_project['end']; ?></span>
                                                </div>
                                                <!--begin::Progress-->
                                            ...
                                            <!--begin::Text-->
                                            <p class="mb-7 mt-3">
                                                <?php echo substr($data_client_list_project['deskripsi'], 0, 200); ?>   
                                            </p>
                                            <!--end::Text-->
                                            <!--begin::Blog-->
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="d-flex flex-column flex-lg-fill float-left mb-7">
                                                    ...
                                                    <div class="symbol-group symbol-hover">
                                                        ...
                                                        <div class="symbol symbol-30 symbol-circle"
                                                            data-toggle="tooltip" title="Charlie Stone">
                                                            <img alt="Pic" src="assets/media/users/300_19.jpg" />
                                                        </div>
                                                        <div class="symbol symbol-30 symbol-circle"
                                                            data-toggle="tooltip" title="Luca Doncic">
                                                            <img alt="Pic" src="assets/media/users/300_22.jpg" />
                                                        </div>
                                                        <div class="symbol symbol-30 symbol-circle"
                                                            data-toggle="tooltip" title="Nick Mana">
                                                            <img alt="Pic" src="assets/media/users/300_23.jpg" />
                                                        </div>
                                                        <div class="symbol symbol-30 symbol-circle"
                                                            data-toggle="tooltip" title="Teresa Fox">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex align-items-center   mr-7">
                                                    <span class="svg-icon svg-icon-gray-500">
                                                        ...
                                                        <!--end::Svg Icon--></span> <a href="#"
                                                        class="font-weight-bolder text-primary ml-2">648 Comments</a>
                                                </div>
                                            </div>
                                            <button type="button"
