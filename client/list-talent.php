                            ...
                            <div class="card card-custom">
                                <div class="card-header">
                                    <div class="card-title">
                                        ...
                                        <h3 class="card-label">List Talent who requests this job</h3>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                                        ...
                                        <tbody>
                                            <?php
                                            $nomor = 1;
                                            while ($data_list_talent_on_project = mysqli_fetch_assoc($query_list_talent_on_project)) {
                                                $idt = $data_list_talent_on_project['idt'];
                                                $query_talent_detail = mysqli_query($conn, "SELECT * FROM talent WHERE idt = '$idt'");
                                                $data_talent_detail = mysqli_fetch_assoc($query_talent_detail);
                                            ?>
                                                <tr>
                                                    <td><?php echo $nomor; ?></td>
                                                    <td><img width="50px" height="auto" src="assets/media/photo/<?php echo $data_talent_detail['pas_photo']; ?>" alt=""></td>
                                                    <td><?php echo $data_talent_detail['name']; ?></td>
                                                    <td><?php echo $data_talent_detail['username']; ?></td>
                                                    <td><?php echo $data_talent_detail['kmp_kom']; ?></td>
                                                    <td><?php echo $data_talent_detail['kmp_persu']; ?></td>
