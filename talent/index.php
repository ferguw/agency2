                             ...
                             <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                 ...
                                 <div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
                                     ...
                                     <ul class="menu-nav ">
                                         ...
                                         <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="menu-link menu-toggle"><span class="menu-text">Job</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                         ...
                                         <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="talent/history" class="menu-link"><span class="menu-text">History</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                         </li>
                                     </ul>
                                     <!--end::Nav-->
                                 </div>
                 ...
                 <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                     ...
                     <div class="d-flex flex-column-fluid">
                         ...
                         <div class=" container ">
                             ...
                             <div class="row">
                                 <?php
                                    while ($data_job_limit = mysqli_fetch_assoc($query_list_job_limit)) {
                                    ?>
                                     <!--begin::Col-->
                                     <div class="col-xl-4">
                                         <!--begin::Card-->
                                         <div class="card card-custom gutter-b card-stretch">
                                             ...
                                             <div class="card-body">
                                                 ...
                                                 <div class="mb-10 mt-5 font-weight-bold ">
                                                     <?php echo substr($data_job_limit['deskripsi'], 0, 120); ?>
                                                 </div>
                                                 <!--end::Description-->
                                                 ...
                                                 <div class="d-flex mb-5">
                                                     <div class="d-flex align-items-center mr-7">
                                                         ...
                                                         <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_job_limit['start']; ?>
                                                         </span>
                                                     </div>
                                                     <div class="d-flex align-items-center">
                                                         <span class="font-weight-bold mr-4">
                                                         ...
                                                         <span class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_job_limit['start']; ?></span>
                                                     </div>
                                                 </div>
                                                 <!--end::Data-->
                                                 <!--begin::Progress-->
                                                 ...
                                                 <div class="d-flex mb-5 align-items-center">
                                                     <a href="talent/view-project?idj=<?php echo $data_job_limit['idj'] ?>" class="btn btn-pj btn-light-info">Detail</a>
                                                 </div>
                                                 <!--ebd::Progress-->
                                             </div>
                                             <!--end::Body-->
                             ...
                             <div class="row justify-content-center">
                                 <!--begin::Col-->
                                 <div class="col-xl-4">
                                     <a href="talent/list-job" class="btn btn-pj btn-primary">Lihat Semua</a>
                                 </div>
                                 <!--end::Col-->
                             </div>
             ...
             <div class="sidebar sidebar-left d-flex flex-row-auto flex-column " id="kt_sidebar">
                 ...
                 <div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
                     ...
                     <div class="card card-custom card-shadowless bg-white gutter-b">
                         <?php $jumlah_tawaran_project_notif = mysqli_num_rows($query_tawaran_project_notif) ?>
                         <!--begin::Header-->
                         <div class="card-header border-0 pt-5">
                             <h3 class="card-title align-items-start flex-column">
                                 <span class="card-label font-weight-bolder text-dark">Tawaran Project</span>
                                 <span class="text-muted mt-3 font-weight-bold font-size-sm"><?php echo $jumlah_tawaran_project_notif; ?> Project Menunggu</span>
                             </h3>
                         </div>
                         <!--end::Header-->
                         ...
                         <div class="card-body pt-4">
                             <div class="timeline timeline-5 mt-3">
                                 ...
                                 <div class="timeline-item align-items-start">
                                     <!--begin::Label-->
                                     <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg">27-08
                                     </div>
                                     <!--end::Label-->
                                 ...
                                 <div class="timeline-item align-items-start">
                                     <!--begin::Label-->
                                     <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg">25-07
                                     </div>
                                     <!--end::Label-->
