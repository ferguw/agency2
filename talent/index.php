                                         ...
                                         <div class="card-body">
                                             ...
                                             <div class="d-flex mb-5">
                                                 <div class="d-flex align-items-center mr-7">
                                                     ...
                                                     <span
                                                         class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_job_limit['start']; ?>         
                                                    </span>
                                                 </div>
                                                 <div class="d-flex align-items-center">
                                                     <span class="font-weight-bold mr-4">
                                                     ...
                                                     <span
                                                         class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_job_limit['start']; ?></span>
                                                 </div>
                                             </div>
                                             <!--end::Data-->
                                             <!--begin::Progress-->
                                             ...
                                             <div class="d-flex mb-5 align-items-center">
                                                 <a href="talent/view-project?idj=<?php echo $data_job_limit['idj'] ?>"
...
?>
                             ...
                             <div class="d-flex align-items-center mb-10">
                                 ...
                                 <div class="d-flex flex-column font-weight-bold">
                                     <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg"><?php echo $data_tawaran_notif_cari['judul']; ?></a>
