                        ...
                        <div class=" container ">
                            ...
                            <div class="row">
                                <div class="col-12 mt-5 text-center">
                                    <h1><?php echo $data_view_tawaran['judul']; ?></h1>
                                </div>
                            </div>
                            <!-- end::tittle -->
                            <!-- detail job -->
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mr-3">
                                                            ...
                                                            <h5
                                                                ...
                                                                <?php echo $data_view_tawaran['judul']; ?> <i
                                                            ...
                                                            <div class="d-flex flex-wrap my-2">
                                                                <a href="#"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <!--end::Svg Icon--></span> <?php echo $data_view_tawaran['email']; ?>
                                                                </a>
                                                                <a href="#"
                                                                    class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                                    <span
                                                        ...
                                                        <div class="my-lg-0 my-1">
                                                            <a href="#"
                                                                class="btn btn-sm btn-light-success font-weight-bolder text-uppercase mr-3">Master
                                                                Of Ceremony</a>
                                                            <a href="#"
                                                                class="btn btn-sm btn-info font-weight-bolder text-uppercase">Sales
                                                                Promotion Girl</a>
                                                        </div>
                                                    </div>
                                                    <!--end: Title-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <?php echo $data_view_project['deskripsi']; ?>
                                                        </div>
                                                        ...
                                                        <div class="d-flex flex-wrap align-items-center py-2">
                                                            <div class="d-flex align-items-center mr-10">
                                                                <div class="mr-6">
                                                                    ...
                                                                    <span
                                                                        class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold"><?php echo $data_view_project['start']; ?></span>
                                                                </div>
                                                                <div class="">
                                                                    <div class="font-weight-bold mb-2">Due Date</div>
                                                                    <span
                                                                        class="btn btn-sm btn-text btn-light-danger text-uppercase font-weight-bold"><?php echo $data_view_project['end']; ?></span>
                                                                </div>
                                                            </div>
                                                            <div
                                                        ...
                                                        <div
                                                            class="flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5 text-center">
                                                            <!-- <a class="btn btn-md btn-light-primary"
                                                                href="talent/view-tawaran">Tolak</a>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a class="btn btn-md btn-danger"
                                                                href="talent/tawaran-job">Terima</a> -->
                                                                
                                                                <form method="POST">
                                                                <input type="text" name="id_tawaran" hidden value="<?php echo $data_view_tawaran_table['idt'];?>">
                                                            <?php
                                                                if ($data_view_tawaran_table['twsts'] == 'belum') {
                                                                    echo"<div
                                                                            class='flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5 text-center'>
                                                                            <button type='submit' name='tolak' class='btn btn-md btn-light-primary'>Tolak</button>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <button type='submit' name='terima' class='btn btn-md btn-danger'>Terima</button>
                                                                            </div>";
                                                                        }else if($data_view_tawaran_table['twsts'] == 'terima'){
                                                                            echo"<div
                                                                            class='flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5 text-center'>
                                                                            <a class='btn btn-md btn-danger' disabled >Anda Menerima Job ini</a>
                                                                            </div>";
                                                                        }else if($data_view_tawaran_table['twsts'] == 'tolak'){
                                                                            echo"<div
                                                                            class='flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5 text-center'>
                                                                            <a class='btn btn-md btn-light-primary' disabled >Anda Menolak Job ini</a>   
                                                                            </div>";
                                                                        }
                                                                        ?>
