...
<head>
    ...
    <meta name="viewport" content="widtfh=device-width, initial-scale=1, shrink-to-fit=no" />
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between flex-wrap mt-1">
                                                <div class="d-flex mr-3">
                                                    <a href="#"
                                                        class="text-dark-75 text-hover-primary font-size-h5 font-weight-bold mr-3"><?php echo $data_profile_talent['name'];?></a>
                                                    <a href="#"><i
                                                            class="flaticon2-correct text-success font-size-h5"></i></a>
                                                </div>

                                                <div class="my-lg-0 my-3">
                                                    <a href="talent/profil-edit"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <img src="assets/media/photo/closeup_1.jpg" width="100%"
                                                        alt="portofolio">
                                                </div>
                                                <div class="col-lg-3">
                                                    <img src="assets/media/photo/pas_1.jpg" width="100%"
                                                        alt="portofolio">
                                                </div>
                                                <div class="col-lg-3">
                                                    <img src="assets/media/photo/full_1.jpg" width="100%"
                                                        alt="portofolio">
                                                </div>
                                            </div>
                                        </div>
