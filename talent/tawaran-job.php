        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-icon-primary p-0 ml-5" id="kt_sidebar_mobile_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Substract.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-9">
                    ...
                    <div class="btn p-0 symbol symbol-40 symbol-success" href="?page=index" id="kt_quick_user_toggle">
                        <div class="symbol-label s-avatar">
                            <img alt="Logo" src="assets/media/svg/avatars/saitama.png" width="" class="h-100 align-self-end" />
                        </div>
                    </div>
                    <!--end::Logo-->
                </div>
                ...
                <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-8">
                    ...
                    <a href="#" class="btn btn-icon btn-lg btn-borderless mb-1 position-relative" id="kt_quick_notifications_toggle" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Notifications">
                        <span class="svg-icon svg-icon-xxl">
                            ...
                            <!--end::Svg Icon--></span> <span class="label label-sm label-light-danger label-rounded font-weight-bolder position-absolute top-0 right-0 mt-1 mr-1">3</span>
                    </a>
                    <!--end::Notifications-->
                                ...
                                <div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
                                    ...
                                    <ul class="menu-nav ">
                                        <li class="menu-item  menu-item-submenu menu-item-rel">
                                            <a href="talent" class="menu-link "><span class="menu-text">Dashboard</span></a>
                                        </li>
                                        <li class="menu-item  menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="menu-link menu-toggle"><span class="menu-text">Job</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                                <ul class="menu-subnav">
                                                    <li class="menu-item menu-item-active" data-menu-toggle="hover" aria-haspopup="true">
                                        ...
                                        <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="talent/report-job" class="menu-link"><span class="menu-text">Report</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                        </li>
                                        <li class="menu-item  menu-item-submenu" data-menu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="menu-link menu-toggle"><span class="menu-text">History</span><span class="menu-desc"></span><i class="menu-arrow"></i></a>
                                                ...
                                                <div class="menu-subnav">
                                                    <ul class="menu-content">
                                                        <li class="menu-item ">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item " aria-haspopup="true"><a href="custom/pages/pricing/pricing-1.html" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Pricing Tables
                                                                            1</span></a></li>
                                                                <li class="menu-item " aria-haspopup="true"><a href="custom/pages/pricing/pricing-2.html" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Pricing Tables
                                                                            2</span></a></li>
                                                                <li class="menu-item " aria-haspopup="true"><a href="custom/pages/pricing/pricing-3.html" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Pricing Tables
                                                                            3</span></a></li>
                                                                <li class="menu-item " aria-haspopup="true"><a href="custom/pages/pricing/pricing-4.html" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Pricing Tables
                                                                            4</span></a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item ">
                                                        ...
                                                        <li class="menu-item ">
                                                            ...
                                                            <ul class="menu-inner">
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true"><a href="custom/pages/login/login-3/signup.html" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Login 3</span><span class="menu-label"><span class="label label-inline label-info">Wizard</span></span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a href="custom/pages/login/login-4/signup.html" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Login 4</span><span class="menu-label"><span class="label label-inline label-info">Wizard</span></span></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item ">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex mb-5">
                                                    <div class="d-flex align-items-center mr-7">
                                                        ...
                                                        <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_tawaran_cari['start']; ?></span>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <span class="font-weight-bold mr-4">
                                                            Due
                                                        </span>
                                                        <span class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_tawaran_cari['end']; ?></span>
                                                    </div>
                                                </div>
                                                <!--end::Data-->
                                                <!--begin::Progress-->
                                                ...
                                                <div class="d-flex mb-5 align-items-center">
                                                    <a href="talent/view-tawaran?idj=<?php echo $data_tawaran_cari['idj'] ?>" class="btn btn-pj btn-light-info">Detail</a>
                                                </div>
                                                <!--ebd::Progress-->
                                            </div>
                                            <!--end::Body-->
                    ...
                    <div class="card card-custom card-shadowless bg-white gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-3 font-weight-bold font-size-sm">2 Project Menunggu</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="card-body pt-8">
                            <?php
                            while ($data_tawaran_project_notif = mysqli_fetch_assoc($query_tawaran_project_notif)) {
                                $idj_tawaran_notif = $data_tawaran_project_notif['idj'];
                                $query_tawaran_notif_cari = mysqli_query($conn, "SELECT * FROM job WHERE idj = '$idj_tawaran_notif'");
                                $data_tawaran_notif_cari = mysqli_fetch_assoc($query_tawaran_notif_cari);
                            ?>
                                <!--begin::Item-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                                <div class="col-12 text-center">
                                    <a href="talent/tawaran-job" class="btn btn-pj btn-light-primary">More</a>
                                </div>
                            </div>
                            <!--end::Item-->
                        </div>
                            ...
                            <div class="timeline timeline-5 mt-3">
                                ...
                                <div class="timeline-item align-items-start">
                                    ...
                                    <div class="timeline-content d-flex">
                                        <span class="font-weight-mormal font-size-lg timeline-content text-muted pl-3">AEOL
                                            meeting</span>
                                    </div>
                                    <!--end::Content-->
                                </div>
    ...
    <div id="kt_quick_notifications" class="offcanvas offcanvas-left p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="navi navi-icon-circle navi-spacer-x-0">
                <!--begin::Item-->
                <?php
                while ($data_notifikasi_talent = mysqli_fetch_assoc($query_notifikasi_talent)) {
                    $id_job_notif = $data_notifikasi_talent['idj'];
                    $query_notif_job_search = mysqli_query($conn, "SELECT * FROM job WHERE idj = '$id_job_notif'");
                    $data_notif_job_search = mysqli_fetch_assoc($query_notif_job_search);
                ?>
                    <!--begin::Item-->
                    <div class="navi-item">
                        <div class="navi-link rounded">
                            ...
                            <div class="navi-text">
                                <div class="font-weight-bold font-size-lg">
                                    <a href="talent/tawaran-job">
                                        <?php echo $data_notifikasi_talent['isi']; ?>
                                    </a>
                                </div>
                                <div class="text-muted">
                                    <?php echo $data_notif_job_search['judul']; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Accounting</span>
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Members</span>
                    </a>
                </div>
                <!--end::Item-->
            </div>
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Projects</span>
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Customers</span>
                    </a>
                </div>
                <!--end::Item-->
            </div>
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Email</span>
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Settings</span>
                    </a>
                </div>
                <!--end::Item-->
            </div>
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                        <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                            ...
                            <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Orders</span>
                    </a>
                </div>
                <!--end::Item-->
            </div>
