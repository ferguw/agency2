                                    ...
                                    <div class="card card-custom gutter-b card-stretch">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-10 mt-5 font-weight-bold ">
                                                <?php echo substr($data_list_job['deskripsi'], 0, 120); ?>
                                            </div>
                                            <!--end::Description-->
                                            ...
                                            <div class="d-flex mb-5">
                                                <div class="d-flex align-items-center mr-7">
                                                    ...
                                                    <span
                                                        class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_list_job['start']; ?></span>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <span class="font-weight-bold mr-4">
                                                        Due
                                                    ...
                                                    <span
                                                        class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text"><?php echo $data_list_job['end']; ?></span>
                                                </div>
                                            </div>
                                            <!--end::Data-->
                                            <!-- begin::Progress-->
                                            ...
                                            <div class="d-flex mb-5 align-items-center">
                                                <a href="talent/view-project?idj=<?php echo $data_list_job['idj'] ?>"
